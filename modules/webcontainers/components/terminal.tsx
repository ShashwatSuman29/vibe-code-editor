...
const TerminalComponent = forwardRef<TerminalRef, TerminalProps>(
  (
    ...
    const clearTerminal2 = useCallback(() => {
      if (term.current) {
        term.current.clear();
        ...
        switch (data) {
          ...
          case "\u0003": // Ctrl+C
            if (
              ...
              typeof currentProcess.current.kill === "function"
            ) {
    ...
    const initializeTerminal = useCallback(() => {
      ...
      setTimeout(() => {
        try {
          ...
          console.warn("Terminal fit skipped (not ready yet)");
        }
      }, 100);
      ...
      const resizeObserver = new ResizeObserver(() => {
        if (fitAddon.current && term.current) {
          try {
            ...
            console.warn("Terminal fit skipped");
          }
        }
      });
