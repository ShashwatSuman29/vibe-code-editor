...
import { TemplateFolder } from "@/modules/playground/lib/page-to-json";
  ...
  useEffect(() => {
    async function setupContainer() {
      ...
      try {
        ...
        // @ts-expect-error - transformToWebContainerFormat is not typed to return a specific type
      ...
      {!previewUrl ? (
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 p-4">
            <TerminalComponent
              ref={terminalRef}
              webContainerInstance={instance as WebContainer | undefined}
              theme="dark"
              className="h-full"
            />
          </div>
