...
import { TemplateFile, TemplateFolder } from "../lib/page-to-json";

// import { Extension } from '@prisma/client/runtime/library.js';
...
interface FileExplorerState {
  ...
  // other file fucntions and features
  handleAddFile: (
...
// @ts-expect-error zustand create does not fully infer generic types without explicit annotation
